...
CREATE TABLE IF NOT EXISTS `projects` (
    ...
    `startDateTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Project Start date',
    `endDateTime` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Project End date',
